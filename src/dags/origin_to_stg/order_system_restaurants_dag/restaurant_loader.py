...
class RestaurantLoader:
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_object_rest(conn, str(d["_id"]), d["update_ts"], d)
...
class UserLoader:
    ...
    def __init__(self, collection_loader: UserReader, pg_dest: PgConnect, pg_saver_u: PgSaver_U, logger: Logger) -> None:
        self.collection_loader = collection_loader
        self.pg_saver = pg_saver_u
        self.pg_dest = pg_dest
        self.settings_repository = StgEtlSettingsRepository()
        self.log = logger
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_object_users(conn, str(d["_id"]), d["update_ts"], d)
...
class OrderLoader:
    ...
    def __init__(self, collection_loader: OrderReader, pg_dest: PgConnect, pg_saver: PgSaver_O, logger: Logger) -> None:
        self.collection_loader = collection_loader
        self.pg_saver = pg_saver
        self.pg_dest = pg_dest
        self.settings_repository = StgEtlSettingsRepository()
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_object_orders(conn, str(d["_id"]), d["update_ts"], d)
